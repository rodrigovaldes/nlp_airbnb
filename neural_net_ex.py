...
_, train_scores, train_vectors = load_vector("results/vector_mix_train.txt", -1);
print("Load dev vectors");
_, dev_scores, dev_vectors = load_vector("results/vector_mix_dev.txt", -1);
print("Load test vectors");
_, test_scores, test_vectors = load_vector("results/vector_mix_test.txt", -1);
